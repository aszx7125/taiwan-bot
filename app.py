...
if target_ticker:
    ...
    with tab2:
        ...
        st.caption("AI 已經排除追高風險。下方高分榜為正處於『量縮回踩、籌碼集中或準備發動』的高勝率標的，請點擊『單股掃描』取得小時區計畫。")
    ...
    with tab3:
        ...
        if st.button("🚀 啟動產業鏈深度掃描", type="primary"):
            ...
            if res:
                ...
                if recommendations:
                    st.success("🎯 以下標的為該產業鏈中，目前正處於『量縮回踩或壓縮整理』的低風險股。建議輸入上方『單股掃描』以 1h 線狙擊進場：")
